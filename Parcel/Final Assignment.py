...
def check_price(destination, weight):
    if weight < 1:
        return table_price[destination]['Weight below 1kg']
    elif 1 <= weight <= 3:
        return table_price[destination]['Weight in between 1kg to 3kg']
    else:
        return table_price[destination]['Weight above 3kg']
